# Hotel Policy Copilot - Beginner Simple RAG

## Project Overview

Hotel Policy Copilot - Beginner Simple RAG is a complete full-stack AI project for **Simple RAG** at **Beginner** difficulty. It includes a FastAPI backend, a React frontend, sample documents, vector search with ChromaDB support, source citations, timeline logs, structured run storage, Docker files, and tests.
...
```text
ai-simple-rag-hotel-policy-copilot/
  backend/
    app/
      main.py
      config.py
